      ...
      <div className="max-w-[900px] mx-auto px-6 py-8">
            ...
            <div>
              ...
              {stakeCount === 0 ? (
                ...
                <div className="flex items-center">
                  ...
                  {stakeCount > 5 && (
                    <span className="text-xs text-[var(--text-sub)] ml-2">+{stakeCount - 5}</span>
                  )}
        ...
        {f.status === 'upcoming' && !myStake && (
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius)] p-6 mb-4">
            ...
            <button className="w-full py-4 rounded-full text-base font-semibold bg-[var(--border)] text-[var(--text-sub)] cursor-not-allowed">
              Soon
            </button>
          </div>
        )}
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius)] p-6 mb-4">
            ...
            <div>
              <div className="flex justify-between items-center py-3 border-b border-[var(--border)]">
                ...
                <span className="text-sm font-semibold font-mono">{fmtAmount(myStake.amount, decimals)} ${f.token_symbol}</span>
              </div>
              <div className="flex justify-between items-center py-3 border-b border-[var(--border)]">
                <span className="text-[13px] text-[var(--text-sub)]">報酬予定</span>
                <span className="text-sm font-semibold font-mono">+{fmtAmount(Math.floor(Number(myStake.amount) * (f.multiplier - 1)), decimals)} ${f.token_symbol}（ペイアウト後に確定）</span>
              </div>
              <div className="flex justify-between items-center py-3 border-b border-[var(--border)]">
                <span className="text-[13px] text-[var(--text-sub)]">受取合計（予定）</span>
                <span className="text-sm font-semibold font-mono">{fmtAmount(Math.floor(Number(myStake.amount) * f.multiplier), decimals)} ${f.token_symbol}</span>
              </div>
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius)] p-6 mb-4">
            ...
            <div>
              ...
              <div className="flex justify-between items-center py-3 border-b border-[var(--border)]">
                ...
                <span className="text-sm font-semibold font-mono">+{fmtAmount(myStake.reward_amount - Number(myStake.amount), decimals)} ${f.token_symbol}</span>
              </div>
              <div className="flex justify-between items-center py-3 border-b border-[var(--border)]">
                <span className="text-[13px] text-[var(--text-sub)]">受取合計</span>
                <span className="text-sm font-semibold font-mono">{fmtAmount(myStake.reward_amount, decimals)} ${f.token_symbol}</span>
              </div>
              <div className="flex justify-between items-center py-3">
                <span className="text-[13px] text-[var(--text-sub)]">ステータス</span>
        ...
        {isClaimed && (
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius)] p-6 mb-4">
            ...
            <div>
              ...
              <div className="flex justify-between items-center py-3 border-b border-[var(--border)]">
                <span className="text-[13px] text-[var(--text-sub)]">報酬</span>
                <span className="text-sm font-semibold font-mono">+{fmtAmount(Number(myStake.reward_amount) - Number(myStake.amount), decimals)} ${f.token_symbol}</span>
              </div>
              <div className="flex justify-between items-center py-3">
                <span className="text-[13px] text-[var(--text-sub)]">ステータス</span>
        ...
        {/* ═══ State: open + not staked → Stake form ═══ */}
        ...
        {!myStake && f.status === 'open' && !connected && (
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius)] p-6 mb-4 text-center">
